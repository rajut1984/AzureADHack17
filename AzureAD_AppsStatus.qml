...
<KSID>
  <Type>Regular</Type>
  <Name>AzureAD_AppsStatus</Name>
  <Desc>Monitors the Registered Applications in Azure Active Directory. The KS monitor the state and health of registered Applications </Desc>
  <Version>
...
<Parameter>
  <Desc>Monitors the Registered Applications in Azure Active Directory. The KS monitor the state and health of applications registered in Azure AD Account.</Desc>
  ...
  <Param name="FDR_AzureADApps">
    <Desc>Azure AD Apps Event Notification</Desc>
    <ReqInput>1</ReqInput>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="FDR_ApssCount">
    <Desc>Registered Apps count event settings</Desc>
    <ReqInput>1</ReqInput>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_Apps_Crossed_TH">
    <Desc>Raise event if number of Apps exceeds threshold?</Desc>
    <Value>y</Value>
    <ReqInput>1</ReqInput>
    <I_Type>I_CHECKBOX("Yes","y","n")</I_Type>
    <Parent>FDR_ApssCount</Parent>
    <Folder>1</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_Apps_Count_Threshold">
    <Desc>Set threshold for number of Apps</Desc>
    <Type>Integer</Type>
    <Min>0</Min>
    <Max>500</Max>
    <Value>5</Value>
    ...
    <ReqInput>1</ReqInput>
    <I_Type>I_SPIN</I_Type>
    <Parent>PRM_Apps_Crossed_TH</Parent>
    <Folder>0</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_Apps_TH_EventSeverity">
    <Desc>Event severity when number of Apps exceeds the threshold</Desc>
    <Type>Integer</Type>
    <Min>1</Min>
    <Max>40</Max>
    <Value>5</Value>
  ...
  <Param name="FDR_AppsStatus">
    <Desc>Registered Apps status notification settings</Desc>
    <ReqInput>1</ReqInput>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_No_Owner_Assigned_Apps_Status">
    <Desc>Raise event if no owner/user is assigned to registered Apps</Desc>
    <Value>y</Value>
    <ReqInput>1</ReqInput>
    <I_Type>I_CHECKBOX("Yes","y","n")</I_Type>
    <Parent>FDR_AppsStatus</Parent>
    <Folder>1</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_No_Owner_Assigned_Apps_Status_EventSeverity">
    <Desc>Event severity when no owner/user is assigned to registered Apps</Desc>
    <Type>Integer</Type>
    <Min>1</Min>
    <Max>40</Max>
    <Value>5</Value>
    ...
    <ReqInput>1</ReqInput>
    <I_Type>I_SPIN</I_Type>
    <Parent>PRM_No_Owner_Assigned_Apps_Status</Parent>
    <Folder>0</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="FDR_NewApp">
    <Desc>New Apps registration event settings</Desc>
    <ReqInput>1</ReqInput>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_Apps_New">
    <Desc>Raise event if any new app is registered in Azure AD</Desc>
    <Value>y</Value>
    <ReqInput>1</ReqInput>
    <I_Type>I_CHECKBOX("Yes","y","n")</I_Type>
    <Parent>FDR_NewApp</Parent>
    <Folder>1</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_Apps_New_EventSeverity">
    <Desc>Event severity when any new app is registered in Azure AD</Desc>
    <Type>Integer</Type>
    <Min>1</Min>
    <Max>40</Max>
    <Value>15</Value>
    ...
    <ReqInput>1</ReqInput>
    <I_Type>I_SPIN</I_Type>
    <Parent>PRM_Apps_New</Parent>
    <Folder>0</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="FDR_DeleteApp">
    <Desc>Deleted registered Apps event settings</Desc>
    <ReqInput>1</ReqInput>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_Apps_Delete">
    <Desc>Raise event if any registered app is deleted in Azure AD</Desc>
    <Value>y</Value>
    <ReqInput>1</ReqInput>
    <I_Type>I_CHECKBOX("Yes","y","n")</I_Type>
    <Parent>FDR_DeleteApp</Parent>
    <Folder>1</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_Apps_Delete_EventSeverity">
    <Desc>Event severity when  any registered app is deleted in Azure AD</Desc>
    <Type>Integer</Type>
    <Min>1</Min>
    <Max>40</Max>
    <Value>15</Value>
...
Sub RunPowerShellScript(strScriptName, arrScriptParams)
  ...
  If strEventMessage = "" Then
      ...
      If Not fso Is Nothing Then
		  ...
		  strFullScriptPath = "C:\Program Files (x86)\NetIQ\AppManager\bin\PowerShell\Scripts\AzureAD_AppsStatus.ps1"
...
'#
gstrScriptName     = "AzureAD_AppsStatus"
gbExchangeOnlineKS = True
garrScriptParams   = Array(SetPSVariable("AzureAD_Apps",                     Null     ), _
					   SetPSVariable("PRM_Apps_Crossed_TH",                         vbBoolean), _
					   SetPSVariable("PRM_Apps_Count_Threshold",						Null     ), _
					   SetPSVariable("PRM_Apps_TH_EventSeverity",						Null     ), _
					   SetPSVariable("PRM_No_Owner_Assigned_Apps_Status",                         vbBoolean), _
					   SetPSVariable("PRM_No_Owner_Assigned_Apps_Status_EventSeverity",						Null     ), _
					   SetPSVariable("PRM_Apps_New",                         vbBoolean), _
					   SetPSVariable("PRM_Apps_New_EventSeverity",           Null     ), _
					   SetPSVariable("PRM_Apps_Delete",                         vbBoolean), _
					   SetPSVariable("PRM_Apps_Delete_EventSeverity",           Null     ), _
					   SetPSVariable("PRM_SeverityFail",                               Null     ), _
                     SetPSVariable("AKPID",                                          Null     ))
garrScriptTargets = Array("AzureAD_Apps")
...
Dim bValid : bValid = False
 ...
 If (Not bValid) And (NQExt.ItemCount(AzureAD_Apps, ",") > 0) Then
If PRM_Apps_Crossed_TH                     = "y" Or _
 PRM_No_Owner_Assigned_Apps_Status              = "y" Or _
 PRM_Apps_New              = "y" Or _
 PRM_Apps_Delete                     = "y" Then
  bValid = True
End If
End If
