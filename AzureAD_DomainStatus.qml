...
<KSID>
  <Type>Regular</Type>
  <Name>AzureAD_DomainStatus</Name>
  <Desc>Monitors the Doamins of Azure Active Directory. The KS monitor the status and health of Domains , </Desc>
  <Version>
...
<ObjType fullpath="1" dropfolderlist="0" styleversion="4">
  <Type name="AzureAD_Domains"></Type>
</ObjType>
...
<Parameter>
  <Desc>Monitors the Domains of Azure Active Directory. The KS monitor the status and health of domains in Azure AD Account.</Desc>
  ...
  <Param name="FDR_AzureADDomains">
    <Desc>Azure AD Domains Event Notification</Desc>
    <ReqInput>1</ReqInput>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="FDR_DomainStatus">
    <Desc>Domain status event settings</Desc>
    <ReqInput>1</ReqInput>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_Domains_Status_Unverify">
    <Desc>Raise event if domain status is Unverified?</Desc>
    <Value>y</Value>
    <ReqInput>1</ReqInput>
    <I_Type>I_CHECKBOX("Yes","y","n")</I_Type>
    <Parent>FDR_DomainStatus</Parent>
    <Folder>1</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_Domains_Status_Unverify_EventSeverity">
    <Desc>Event severity when domain status is Unverified</Desc>
    <Type>Integer</Type>
    <Min>1</Min>
    <Max>40</Max>
    <Value>15</Value>
    ...
    <ReqInput>1</ReqInput>
    <I_Type>I_SPIN</I_Type>
    <Parent>PRM_Domains_Status_Unverify</Parent>
    <Folder>0</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="FDR_NewCustomDomain">
    <Desc>New Custom Doamin(s) event settings</Desc>
    <ReqInput>1</ReqInput>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_CusomtomDomain_New">
    <Desc>Raise event if any custom domain is created/added in Azure AD</Desc>
    <Value>y</Value>
    <ReqInput>1</ReqInput>
    <I_Type>I_CHECKBOX("Yes","y","n")</I_Type>
    <Parent>FDR_NewCustomDomain</Parent>
    <Folder>1</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_CusomtomDomain_New_EventSeverity">
    <Desc>Event severity when any custom domain is created/added in Azure AD</Desc>
    <Type>Integer</Type>
    <Min>1</Min>
    <Max>40</Max>
    <Value>5</Value>
    ...
    <ReqInput>1</ReqInput>
    <I_Type>I_SPIN</I_Type>
    <Parent>PRM_CusomtomDomain_New</Parent>
    <Folder>0</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="FDR_DeleteCustomDomain">
    <Desc>Deleted Custom Doamin(s) event settings</Desc>
    <ReqInput>1</ReqInput>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_CusomtomDomain_Deleted">
    <Desc>Raise event if any custom domain(s) is deleted in Azure AD</Desc>
    <Value>y</Value>
    <ReqInput>1</ReqInput>
    <I_Type>I_CHECKBOX("Yes","y","n")</I_Type>
    <Parent>FDR_DeleteCustomDomain</Parent>
    <Folder>1</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_Group_Deleted_EventSeverity">
    <Desc>Event severity when any custom domain(s) is deleted in Azure AD</Desc>
    <Type>Integer</Type>
    <Min>1</Min>
    <Max>40</Max>
    <Value>5</Value>
    ...
    <ReqInput>1</ReqInput>
    <I_Type>I_SPIN</I_Type>
    <Parent>PRM_CusomtomDomain_Deleted</Parent>
    <Folder>0</Folder>
    <NoQuote>0</NoQuote>
  </Param>
...
Sub RunPowerShellScript(strScriptName, arrScriptParams)
  ...
  If strEventMessage = "" Then
      ...
      If Not fso Is Nothing Then
		  ...
		  strFullScriptPath = "C:\Program Files (x86)\NetIQ\AppManager\bin\PowerShell\Scripts\AzureAD_DomainStatus.ps1"
...
'#
gstrScriptName     = "AzureAD_DomainStatus"
gbExchangeOnlineKS = True
garrScriptParams   = Array(SetPSVariable("AzureAD_Domains",                     Null     ), _
					   SetPSVariable("PRM_Domains_Status_Unverify",                         vbBoolean), _
					   SetPSVariable("PRM_Domains_Status_Unverify_EventSeverity",						Null     ), _
					   SetPSVariable("PRM_CusomtomDomain_New",                         vbBoolean), _
					   SetPSVariable("PRM_CusomtomDomain_New_EventSeverity",           Null     ), _
					   SetPSVariable("PRM_CusomtomDomain_Deleted",                         vbBoolean), _
					   SetPSVariable("PRM_Group_Deleted_EventSeverity",           Null     ), _
					   SetPSVariable("PRM_SeverityFail",                               Null     ), _
                     SetPSVariable("AKPID",                                          Null     ))
garrScriptTargets = Array("AzureAD_Domains")
...
Dim bValid : bValid = False
 ...
 If (Not bValid) And (NQExt.ItemCount(AzureAD_Domains, ",") > 0) Then
If PRM_Domains_Status_Unverify                     = "y" Or _
 PRM_CusomtomDomain_New              = "y" Or _
 PRM_CusomtomDomain_Deleted                     = "y" Then
  bValid = True
End If
End If
