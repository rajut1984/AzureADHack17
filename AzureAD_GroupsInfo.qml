...
<KSID>
  <Type>Regular</Type>
  <Name>AzureAD_GroupsInfo</Name>
  <Desc>Monitors the Groups of Azure Active Directory. The KS monitor the number of groups , any new group created and existring group removed from Azure AD Account</Desc>
  <Version>
...
<Parameter>
  ...
  <Param name="FDR_AzureADGroups">
    <Desc>Azure AD Groups Event Notification</Desc>
    <ReqInput>1</ReqInput>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="FDR_GroupsCount">
    <Desc>Groups count event settings</Desc>
    <ReqInput>1</ReqInput>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_Groups_Crossed_TH">
    <Desc>Raise event if number of groups exceeds threshold?</Desc>
    <Value>y</Value>
    <ReqInput>1</ReqInput>
    <I_Type>I_CHECKBOX("Yes","y","n")</I_Type>
    <Parent>FDR_GroupsCount</Parent>
    <Folder>1</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_Groups_Count_Threshold">
    <Desc>Set threshold for Number of Groups</Desc>
    <Type>Integer</Type>
    <Min>1</Min>
    <Max>100000</Max>
    <Value>2</Value>
    ...
    <ReqInput>1</ReqInput>
    <I_Type>I_SPIN</I_Type>
    <Parent>PRM_Groups_Crossed_TH</Parent>
    <Folder>0</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_Groups_TH_EventSeverity">
    <Desc>Event severity when number of groups exceeds the threshold</Desc>
    <Type>Integer</Type>
    <Min>1</Min>
    <Max>40</Max>
    <Value>15</Value>
  ...
  <Param name="FDR_NewGroup">
    <Desc>New Group event settings</Desc>
    <ReqInput>1</ReqInput>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_New_Group_Creat">
    <Desc>Raise event if new group is created in Azure AD</Desc>
    <Value>y</Value>
    <ReqInput>1</ReqInput>
    <I_Type>I_CHECKBOX("Yes","y","n")</I_Type>
    <Parent>FDR_NewGroup</Parent>
    <Folder>1</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_New_Group_Created_EventSeverity">
    <Desc>Event severity when new group is created in Azure AD </Desc>
    <Type>Integer</Type>
    <Min>1</Min>
    <Max>40</Max>
    <Value>5</Value>
    ...
    <ReqInput>1</ReqInput>
    <I_Type>I_SPIN</I_Type>
    <Parent>PRM_New_Group_Creat</Parent>
    <Folder>0</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="FDR_GroupDeleted">
    <Desc>Deleted Group(s) event settings</Desc>
    <ReqInput>1</ReqInput>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_Group_Deleted">
    <Desc>Raise event if any group is deleted in Azure AD</Desc>
    <Value>y</Value>
    <ReqInput>1</ReqInput>
    <I_Type>I_CHECKBOX("Yes","y","n")</I_Type>
    <Parent>FDR_GroupDeleted</Parent>
    <Folder>1</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_Group_Deleted_EventSeverity">
    <Desc>Event severity when any group is deleted in Azure AD </Desc>
    <Type>Integer</Type>
    <Min>1</Min>
    <Max>40</Max>
    <Value>5</Value>
    ...
    <ReqInput>1</ReqInput>
    <I_Type>I_SPIN</I_Type>
    <Parent>PRM_Group_Deleted</Parent>
    <Folder>0</Folder>
    <NoQuote>0</NoQuote>
  </Param>
...
Sub RunPowerShellScript(strScriptName, arrScriptParams)
  ...
  If strEventMessage = "" Then
      ...
      If Not fso Is Nothing Then
		  ...
		  strFullScriptPath = "C:\Program Files (x86)\NetIQ\AppManager\bin\PowerShell\Scripts\AzureAD_GroupsInfo.ps1"
		  Trace TRACE_ERROR, "Cloud AD Groups : Full AM path is  " & strFullScriptPath
...
'#
gstrScriptName     = "AzureAD_GroupsInfo"
gbExchangeOnlineKS = True
garrScriptParams   = Array(SetPSVariable("AzureAD_Users_Groups",                     Null     ), _
					   SetPSVariable("PRM_Groups_Crossed_TH",                         vbBoolean), _
					   SetPSVariable("PRM_Groups_Count_Threshold",						Null     ), _
					   SetPSVariable("PRM_Groups_TH_EventSeverity",						Null     ), _
					   SetPSVariable("PRM_New_Group_Creat",                  vbBoolean), _
					   SetPSVariable("PRM_New_Group_Created_EventSeverity",        Null     ), _
					   SetPSVariable("PRM_Group_Deleted",                         vbBoolean), _
...
If PRM_Groups_Crossed_TH                     = "y" Or _
 PRM_New_Group_Creat              = "y" Or _
 PRM_Group_Deleted                     = "y" Then
  bValid = True
End If
End If
