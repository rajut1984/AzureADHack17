...
<KSID>
  <Type>Regular</Type>
  <Name>AzureAD_UsersInfo</Name>
  <Desc>Monitors the Users of Azure Active Directory. The KS monitor the number of Users , any new user created and existring user removed from Azure AD Account</Desc>
  <Version>
...
<ObjType fullpath="1" dropfolderlist="0" styleversion="4">
  <Type name="AzureAD_Users_Groups"></Type>
</ObjType>
...
<Parameter>
  <Desc>Monitors the Users of Azure Active Directory. The KS monitor the number of Users , any new user created and existing user removed from Azure AD Account.</Desc>
  ...
  <Param name="FDR_AzureADUsers">
    <Desc>Azure AD Users Event Notification</Desc>
    <ReqInput>1</ReqInput>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="FDR_UsersCount">
    <Desc>Users count event settings</Desc>
    <ReqInput>1</ReqInput>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_Users_Crossed_TH">
    <Desc>Raise event if number of users exceeds threshold?</Desc>
    <Value>y</Value>
    <ReqInput>1</ReqInput>
    <I_Type>I_CHECKBOX("Yes","y","n")</I_Type>
    <Parent>FDR_UsersCount</Parent>
    <Folder>1</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_Users_Count_Threshold">
    <Desc>Set threshold for Number of Users</Desc>
    <Type>Integer</Type>
    <Min>1</Min>
    <Max>100000</Max>
    <Value>2</Value>
    ...
    <ReqInput>1</ReqInput>
    <I_Type>I_SPIN</I_Type>
    <Parent>PRM_Users_Crossed_TH</Parent>
    <Folder>0</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_Users_TH_EventSeverity">
    <Desc>Event severity when number of users exceeds the threshold</Desc>
    <Type>Integer</Type>
    <Min>1</Min>
    <Max>40</Max>
    <Value>15</Value>
  ...
  <Param name="FDR_NewUser">
    <Desc>New User event settings</Desc>
    <ReqInput>1</ReqInput>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_New_User_Creat">
    <Desc>Raise event if new user is created in Azure AD</Desc>
    <Value>y</Value>
    <ReqInput>1</ReqInput>
    <I_Type>I_CHECKBOX("Yes","y","n")</I_Type>
    <Parent>FDR_NewUser</Parent>
    <Folder>1</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_New_User_Created_EventSeverity">
    <Desc>Event severity when new user is created in Azure AD </Desc>
    <Type>Integer</Type>
    <Min>1</Min>
    <Max>40</Max>
    <Value>5</Value>
    ...
    <ReqInput>1</ReqInput>
    <I_Type>I_SPIN</I_Type>
    <Parent>PRM_New_User_Creat</Parent>
    <Folder>0</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="FDR_UserDeleted">
    <Desc>Deleted User(s) event settings</Desc>
    <ReqInput>1</ReqInput>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_User_Deleted">
    <Desc>Raise event if any user is deleted in Azure AD</Desc>
    <Value>y</Value>
    <ReqInput>1</ReqInput>
    <I_Type>I_CHECKBOX("Yes","y","n")</I_Type>
    <Parent>FDR_UserDeleted</Parent>
    <Folder>1</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_User_Deleted_EventSeverity">
    <Desc>Event severity when any user is deleted in Azure AD </Desc>
    <Type>Integer</Type>
    <Min>1</Min>
    <Max>40</Max>
    <Value>5</Value>
    ...
    <ReqInput>1</ReqInput>
    <I_Type>I_SPIN</I_Type>
    <Parent>PRM_User_Deleted</Parent>
    <Folder>0</Folder>
    <NoQuote>0</NoQuote>
  </Param>
...
Sub RunPowerShellScript(strScriptName, arrScriptParams)
  ...
  If strEventMessage = "" Then
      ...
      If Not fso Is Nothing Then
		  ...
		  strFullScriptPath = "C:\Program Files (x86)\NetIQ\AppManager\bin\PowerShell\Scripts\AzureAD_UsersInfo.ps1"
		  Trace TRACE_ERROR, "Cloud AD Users : Full AM path is  " & strFullScriptPath
...
'#
gstrScriptName     = "AzureAD_UsersInfo"
gbExchangeOnlineKS = True
garrScriptParams   = Array(SetPSVariable("AzureAD_Users_Groups",                     Null     ), _
					   SetPSVariable("PRM_Users_Crossed_TH",                         vbBoolean), _
					   SetPSVariable("PRM_Users_Count_Threshold",						Null     ), _
					   SetPSVariable("PRM_Users_TH_EventSeverity",						Null     ), _
					   SetPSVariable("PRM_New_User_Creat",                  vbBoolean), _
					   SetPSVariable("PRM_New_User_Created_EventSeverity",        Null     ), _
					   SetPSVariable("PRM_User_Deleted",                         vbBoolean), _
					   SetPSVariable("PRM_User_Deleted_EventSeverity",           Null     ), _			   
					   SetPSVariable("PRM_SeverityFail",                               Null     ), _
                     SetPSVariable("AKPID",                                          Null     ))
garrScriptTargets = Array("AzureAD_Users_Groups")
...
Dim bValid : bValid = False
 ...
 If (Not bValid) And (NQExt.ItemCount(AzureAD_Users_Groups, ",") > 0) Then
If PRM_Users_Crossed_TH                     = "y" Or _
 PRM_New_User_Creat              = "y" Or _
 PRM_User_Deleted                     = "y" Then
  bValid = True
End If
End If
