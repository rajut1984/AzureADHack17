...
<KSID>
  <Type>Discovery</Type>
  <Name>Discovery_AzureAD</Name>
  <Desc>Discovers Azure Active Directory and resources.</Desc>
  <Version>
...
<Parameter>
  <Desc>Discovers Azure Active Directory and resources. Always raises an event if the job fails and optionally raises events to indicate discovery status: successful or failed.</Desc>
  ...
  <Param name="PRM_LoadExchangeSnapinAs">
    <Desc>Mechanism to use to load the Exchange snap-in (Snapin, Module, or Default)</Desc>
    <Value>Default</Value>
    <ReqInput>1</ReqInput>
  ...
  <Param name="FDR_Discover">
    <Desc>Discovery</Desc>
    <ReqInput>0</ReqInput>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_Domains">
    <Desc>Comma seperated list of Exchange Online Domains to be discovered</Desc>
    <Delim>,</Delim>
    <Type>String</Type>
    <Size>256</Size>
    <Value>novellSMG.onmicrosoft.com</Value>
    <ReqInput>1</ReqInput>
    <Parent>FDR_Discover</Parent>
    <Folder>0</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="FDR_EventNotification">
    <Desc>Event Notification</Desc>
    <ReqInput>0</ReqInput>
    <Parent>FDR_Discover</Parent>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
  </Param>
  <Param name="PRM_EventDiscoverySuccessful">
    <Desc>Raise event if discovery succeeds?</Desc>
    <Type>String</Type>
    <Size>1</Size>
    <Range>ynYN</Range>
    <Value>n</Value>
    ...
    <Parent>FDR_EventNotification</Parent>
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
    <OldParameter>DO_EVENT</OldParameter>
  </Param>
  <Param name="PRM_SeverityDiscoverySuccessful">
    <Desc>Event severity when discovery succeeds</Desc>
    <Type>Integer</Type>
    <Min>1</Min>
    <Max>40</Max>
    <Value>25</Value>
    ...
    <ReqInput>1</ReqInput>
    <I_Type>I_SPIN</I_Type>
    <Parent>PRM_EventDiscoverySuccessful</Parent>
    <Folder>0</Folder>
    <NoQuote>0</NoQuote>
    <OldParameter>InfoLevel</OldParameter>
  </Param>
  <Param name="PRM_EventDiscoveryFailed">
    <Desc>Raise event if discovery fails?</Desc>
    <Type>String</Type>
    <Size>1</Size>
    <Range>ynYN</Range>
    <Value>y</Value>
    ...
    <Folder>2</Folder>
    <NoQuote>0</NoQuote>
    <OldParameter>ErrorLevel</OldParameter>
  </Param>
  <Param name="PRM_SeverityDiscoveryFailed">
    <Desc>Event severity when discovery fails</Desc>
    <Type>Integer</Type>
    <Min>1</Min>
    <Max>40</Max>
    <Value>5</Value>
    ...
    <ReqInput>1</ReqInput>
    <I_Type>I_SPIN</I_Type>
    <Parent>PRM_EventDiscoveryFailed</Parent>
    <Folder>0</Folder>
    <NoQuote>0</NoQuote>
  </Param>
...
<Discovery>
  ...
  <DeltaDiscovery>
    <PerformFullDiscOnFirstIt>1</PerformFullDiscOnFirstIt>
    <Addition>1</Addition>
    <Deletion>1</Deletion>
    <Relocation>1</Relocation>
    <Rename>1</Rename>
    <IncludeObjectDetailChanges>1</IncludeObjectDetailChanges>
    <SeverityOfChangeEvent>25</SeverityOfChangeEvent>
    <EventFormatHTML>1</EventFormatHTML>
    <SeverityOfFailureEvent>5</SeverityOfFailureEvent>
  </DeltaDiscovery>
</Discovery>
...
'###
'### Filename:  Discovery_ExchangeOnline.qml
'### $Revision: #58 $
'###
...
Private gstrTraceLevel             : gstrTraceLevel             = "Debug"             ' PRM_TraceLevel
...
Sub RunPowerShellScript(strScriptName, arrScriptParams)
  ...
  If gbExchangeOnlineKS = True Then
		...
		'End If
		If strFailedPrerequisites <> "" Then
			strEventMessage  = "One or more pre-requisites required to monitor Azure AD failed."
			...
			strDetailMessage = strDetailMessage & "Pre-requisites required for Monitoring Azure AD:" & vbCrlf
		...
		End If		
	Else
		If Not IsExchangeServerInstalled() Then
			'
			' Exchange Server was not found.  Set the short and detailed event messages to be passed
			' to the CreateEvent callback at the end of this subroutine.
			'
			gintFailureSeverity = PRM_SeverityDiscoveryFailed
			
			If(gstrScriptName = "Discovery_ExchangeDAG")Then 
			  strEventMessage  = "Microsoft Exchange Server 2010/2013/2016 is not installed"
			  strDetailMessage = "Microsoft Exchange Server 2010/2013/2016 is not installed " _
								 & "on this host.  You must install the product before monitoring its components."
			Else  
			  strEventMessage  = "Microsoft Exchange Server is not installed"
			  strDetailMessage = "None of Microsoft Exchange Server versions 2007, 2010, 2013 or 2016 is installed " _
							   & "on this host.  You must install the product before monitoring its components."
			End If
  ...
  If strEventMessage = "" Then
      ...
      If Not fso Is Nothing Then
		  ...
		  strFullScriptPath = "C:\Program Files (x86)\NetIQ\AppManager\bin\PowerShell\Scripts\Discovery_AzureAD.ps1"
		  Trace TRACE_ERROR, "Cloud : FUll AM path is  " & strFullScriptPath
		  
		  strFullScriptPath = "C:\Program Files (x86)\NetIQ\AppManager\bin\PowerShell\Scripts\Discovery_AzureAD.ps1"
		  Trace TRACE_ERROR, "Cloud PS1 file path added"
		
          If Not fso.FileExists(strFullScriptPath) Then
              strEventMessage  = "AppManager for Azure AD is not installed"
              strDetailMessage = "AppManager for Azure AD does not appear " _
                               & "to be installed on this agent; the " & strScriptName & ".ps1 PowerShell " _
                               & "script is not present in the path" & strFullScriptPath
          End If
		  ' Raju Revert this , hardcoding strEventMessage as fso.FileExists is failing 
		  ' strEventMessage  = ""
          Set fso = Nothing
      End If
  End If
  ...
  If strEventMessage = "" Then
      ...
      Else
			...
			If gbExchangeOnlineKS = False Then
				strDetailMessage = strDetailMessage & "AppManager for Azure AD is not installed on this host."
			Else
				strDetailMessage = strDetailMessage & "This error could happen because of the following reasons:"  & vbCrlf
				strDetailMessage = strDetailMessage & "1. AppManager for Azure AD not installed on this host." & vbCrlf
...
Function IsExchangeServer2007Installed()
  ...
  NQExt.QTrace "Begin IsExchangeServer2007Installed" 
  Err.Clear
  NQExt.QTrace "Before GetRegistryValue" 
  lngMajorVersion = GetRegistryValue(cstrExchange2007SetupKey, cstrProductMajorValue)
  NQExt.QTrace "lngMajorVersion = " & lngMajorVersion

  If Err.Number = 0 Then
      NQExt.QTrace "IsExchangeServer2007Installed - " & cstrProductMajorValue & ": " & lngMajorVersion
      If lngMajorVersion = 8 Then
        lngMinorVersion = GetRegistryValue(cstrExchange2007SetupKey, cstrProductMinorValue)
          If Err.Number = 0 Then
              NQExt.QTrace "IsExchangeServer2007Installed - " & cstrProductMinorValue & ": " & lngMinorVersion
              bExchangeInstalled = lngMinorVersion >= 0
          Else
              NQExt.QTrace "IsExchangeServer2007Installed: Unable to retrieve registry key: " _
                                           & cstrExchange2007SetupKey & cstrProductMinorValue
          End If
      End If
  Else
      NQExt.QTrace "IsExchangeServer2007Installed: Unable to retrieve registry key: " _
                                   & cstrExchange2007SetupKey & cstrProductMajorValue
  End If

  If Not bExchangeInstalled Then
      NQExt.QTrace "IsExchangeServer2007Installed: Checking for backup registry key."
      bExchangeInstalled = DoesRegistryKeyExist(cstrExchange2007BackupKey)

      If bExchangeInstalled Then
          NQExt.QTrace "IsExchangeServer2007Installed: Assuming Exchange 2007 is " _
                                        & "installed based on backup registry key."
      Else
          NQExt.QTrace "IsExchangeServer2007Installed: Assuming Exchange 2007 is " _
                                        & "not installed (no backup registry key)."
      End If
  End If
  Err.Clear
  IsExchangeServer2007Installed = bExchangeInstalled
  NQExt.QTrace " Exit - IsExchangeServer2007Installed = " & IsExchangeServer2007Installed
End Function


Function IsExchangeServer2010Installed()
...
NQExt.QTrace " Begin IsExchangeServer2010Installed"

  Err.Clear
lngMajorVersion = GetRegistryValue(cstrExchange2010SetupKey, cstrProductMajorValue)
  If Err.Number = 0 Then
      NQExt.QTrace "IsExchangeServer2010Installed - " & cstrProductMajorValue & ": " & lngMajorVersion
      If lngMajorVersion = 14 Then
        lngMinorVersion = GetRegistryValue(cstrExchange2010SetupKey, cstrProductMinorValue)
          If Err.Number = 0 Then
              NQExt.QTrace "IsExchangeServer2010Installed - " & cstrProductMinorValue & ": " & lngMinorVersion
              bExchangeInstalled = lngMinorVersion >= 0
          Else
              NQExt.QTrace "IsExchangeServer2010Installed: Unable to retrieve registry key: " _
                                           & cstrExchange2010SetupKey & cstrProductMinorValue
          End If
      End If
  Else
      NQExt.QTrace "IsExchangeServer2010Installed: Unable to retrieve registry key: " _
                                   & cstrExchange2010SetupKey & cstrProductMajorValue
  End If

  If Not bExchangeInstalled Then
      NQExt.QTrace "IsExchangeServer2010Installed: Checking for backup registry key."
      bExchangeInstalled = DoesRegistryKeyExist(cstrExchange2010BackupKey)

      If bExchangeInstalled Then
          NQExt.QTrace "IsExchangeServer2010Installed: Assuming Exchange 2010 is " _
                                        & "installed based on backup registry key."
      Else
          NQExt.QTrace "IsExchangeServer2010Installed: Assuming Exchange 2010 is " _
                                        & "not installed (no backup registry key)."
  ...
  End If  
  Err.Clear
  IsExchangeServer2010Installed = bExchangeInstalled
  NQExt.QTrace " Exit - IsExchangeServer2010Installed IsExchangeServer2010Installed= " & IsExchangeServer2010Installed
End Function

Function IsExchangeServer2013or2016Installed()

  Dim lngMajorVersion
  Dim lngMinorVersion
  Dim bExchangeInstalled
	Dim bExchange2013Installed
	Dim bExchange2016Installed
  
	bExchangeInstalled = False
  bExchange2013Installed = False
	bExchange2016Installed = False

  NQExt.QTrace " Begin IsExchangeServer2013or2016Installed"

  Err.Clear
  lngMajorVersion = GetRegistryValue(cstrExchange2013_or_2016SetupKey , cstrProductMajorValue)
  If Err.Number = 0 Then
      NQExt.QTrace "IsExchangeServer2013or2016Installed - " & cstrProductMajorValue & ": " & lngMajorVersion
      If lngMajorVersion = 15 Then
          lngMinorVersion = GetRegistryValue(cstrExchange2013_or_2016SetupKey , cstrProductMinorValue)
          If Err.Number = 0 Then
              NQExt.QTrace "IsExchangeServer2013or2016Installed - " & cstrProductMinorValue & ": " & lngMinorVersion
				If lngMinorVersion = 0 Then
					bExchange2013Installed = True
					bExchangeInstalled = True
				Else If lngMinorVersion = 1 Then
					bExchange2016Installed = True
					bExchangeInstalled = True
				End If
				End If
				
          Else
              NQExt.QTrace "IsExchangeServer2013or2016Installed: Unable to retrieve registry key: " _
                                           & cstrExchange2013_or_2016SetupKey & cstrProductMinorValue
          End If
      End If
  Else
    NQExt.QTrace "IsExchangeServer2013or2016Installed: Unable to retrieve registry key: " _
                                 & cstrExchange2013_or_2016SetupKey & cstrProductMajorValue
  End If

  If Not bExchangeInstalled Then
      NQExt.QTrace "IsExchangeServer2013or2016Installed: Checking for backup registry key."
      bExchangeInstalled = DoesRegistryKeyExist(cstrExchange2013_or_2016BackupKey)

      If bExchangeInstalled Then
          NQExt.QTrace "IsExchangeServer2013or2016Installed: Assuming Exchange 2013/2016 is " _
                                        & "installed based on backup registry key."
      Else
          NQExt.QTrace "IsExchangeServer2013or2016Installed: Assuming Exchange 2013/2016 is " _
                                        & "not installed (no backup registry key)."
  ...
  Err.Clear
	...
	If bExchange2013Installed Then
		NQExt.QTrace "IsExchangeServer2013or2016Installed : Exchange Server 2013 is installed"
	Else If  bExchange2016Installed Then
		NQExt.QTrace "IsExchangeServer2013or2016Installed : Exchange Server 2016 is installed"
	End If
	End If
  
	IsExchangeServer2013or2016Installed = bExchangeInstalled

	NQExt.QTrace "IsExchangeServer2013or2016Installed - Exit : IsExchangeServer2013or2016Installed = " & IsExchangeServer2013or2016Installed
...
'# Actions
'#
Private PRM_ActionDiscoveryFailed        : PRM_ActionDiscoveryFailed        = AKPID
Private PRM_ActionDiscoveryPartial       : PRM_ActionDiscoveryPartial       = AKPID
Private PRM_ActionDiscoverySuccessful    : PRM_ActionDiscoverySuccessful    = ""

'#
'# These two global variables MUST be defined!
'#
'# gstrResourceName   - The name of the resource object on which to create error events.
'# gstrResourceObject - The value of the variable corresponding to the resource object.
'#
gstrResourceName   = "NT_MachineFolder"
gstrResourceObject =  NT_MachineFolder
...
gstrScriptName   = "Discovery_AzureAD"
gbExchangeOnlineKS = True
garrScriptParams = Array(SetPSVariable("NT_MachineFolder",                    Null     ), _
					   SetPSVariable("PRM_Domains",              		      Null     ), _
                     SetPSVariable("PRM_EventDiscoverySuccessful",          vbBoolean), _
                     SetPSVariable("PRM_SeverityDiscoverySuccessful",       Null     ), _
                     SetPSVariable("PRM_EventDiscoveryFailed",              vbBoolean), _
                     SetPSVariable("PRM_SeverityDiscoveryFailed",           Null     ), _
                     SetPSVariable("PRM_EventDiscoveryPartial",             vbBoolean), _
                     SetPSVariable("PRM_SeverityDiscoveryPartial",          Null     ), _
                     SetPSVariable("PRM_ActionDiscoveryFailed",             Null     ), _
                     SetPSVariable("PRM_ActionDiscoveryPartial",            Null     ), _
                     SetPSVariable("PRM_ActionDiscoverySuccessful",         Null     ), _
